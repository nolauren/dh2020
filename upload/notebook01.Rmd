...
Next, the following code uses the function `read_csv` to load this data set into
R, save it as an object called `food`, and prints out the first several rows.
...
What are the observations in the data set. **Answer**:

List three of the variables in the data set. **Answer**:
